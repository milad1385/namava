...
export const metadata: Metadata = {
  ...
  description:
    "تماشای آنلاین جدیدترین فیلم ها، سریال ها، انیمیشن ها و همچنین پخش زنده‌ مسابقات ورزشی در میلا فیلم. برای مشاهده‌ی محتوای دلخواهتان ثبت‌نام کنید. ما در دهکده میلا فیلم به تمامی نیاز های شما برای تماشای فیلم و سریال های روز داریم ، هر نوع فیلمی یا سریالی در هر نوع ژانر در این دهکده تماشایی وجود دارد فقط کافی است راجع آن سرچ و جستجو داشته باشید ، ارادتمند شما میلاد سلامیان",
  keywords:
    "میلا فیلم ، تماشای فیلم ، سریال ، آنلاین ، بدون محدودیت ، رایگان ، اشتراکی",
};

async function AboutUs() {
  const user = await authUser();
  const hasPlan = user?.subscriptionEnd > Date.now();
  return (
      ...
      <div className="container">
        <section className="md:absolute md:top-[550px] md:right-0 md:left-0  mx-auto z-20">
          ...
          <p className="text-base mx-auto md:text-lg text-center text-white mt-8 max-w-[780px]">
            ...
            زنده‌ مسابقات ورزشی در میلا فیلم. برای مشاهده‌ی محتوای دلخواهتان
            ثبت‌نام کنید.
          </p>
        </section>
          ...
          <div className="pt-[80px]">
            ...
            <div className="live-section p-5 md:p-0 flex items-center flex-col md:flex-row gap-x-16 text-white">
              ...
              <div className="space-y-5 md:space-y-12 flex-center md:block flex-col">
                ...
                <p className="text-base md:text-3xl font-IranMedium">
                  پخش زنده مهم‌ترین رویدادهای ورزشی در میلا فیلم
                </p>
                <p className="max-w-[727px]  text-center md:text-right text-sm/6 md:text-lg">
                  ...
                  بسکتبال، فرمول 1، بیلیارد، اسنوکر و... بدون نیاز به خرید
                  اشتراک در میلا فیلم
                </p>
            ...
            <div className="max-w-[1112px] p-5 md:p-0  mx-auto flex flex-col md:flex-row items-center gap-y-6 gap-x-5 text-white">
              <div className="space-y-4 flex flex-col  items-center md:items-start">
                <KidLogo className="md:!w-[200px]" />
                <p className="text-sm/[28px] md:text-xl/9 md:w-[577px] text-center md:text-right">
                  برای فرزند خود یک پروفایل جداگانه بسازید، تصویر شخصیت محبوب
                  فرزندتان را انتخاب کنید و با خیال راحت محتوای متناسب با سن
                  کودکتان را پخش کنید.
                  <br />
                  به‌علاوه می‌توانید محتوای نامناسب از نظر خودتان را از دسترس
                  کودک حذف و حتی میزان و ساعت‌های تماشای محتوای فرزندتان را
                  مدیریت کنید.
                </p>
              </div>
            ...
            <div className="max-w-[1300px] mt-16 text-white mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 place-items-center items-center">
              ...
              <div className="flex-center flex-col">
                ...
                <p className="max-w-[256px] h-[93px] text-sm md:text-base/8 text-center mt-5">
                  پیشنهادهای شگفت انگیز میلا فیلم براساس علاقه‌مندی‌ها و
              ...
              <div className="flex-center flex-col">
                ...
                <p className="max-w-[256px] h-[93px] text-sm md:text-base/8 text-center mt-5">
                  اکران آنلاین بهترین‌ فیلم‌های روز سینمای ایران در پردیس میلا
                  فیلم
                </p>
              </div>
            </div>
            ...
            <div className="flex px-4 md:px-0 flex-col md:flex-row justify-center gap-12 mt-16">
              <div className="md:w-[384px] flex flex-col items-center gap-y-4 h-[509px] text-white bg-[#37383e] px-[24px] pt-[56px] pb-[46px] border-[2px] border-gray-400 rounded-xl">
                ...
                <p className="text-center mt-10 leading-8 text-[14px] md:text-base">
                  دسترسی نامحدود به تمام محتوای میلا فیلم
                </p>
              </div>
              <div className="md:w-[384px] h-[509px] flex flex-col items-center gap-y-4 text-white bg-[#37383e] px-[24px] pt-[56px] pb-[46px] border-[2px] border-gray-400 rounded-xl">
                ...
                <p className="text-center mt-10 leading-8 text-[14px] md:text-base">
                  یکبار پرداخت کنید، یکسال اشتراک داشته باشید. تمدید خودکار
                  اشتراک میلا فیلم از طریق شیوه نوین پرداخت بانکی
                </p>
              </div>
            </div>

            <Link href={hasPlan ? "" : "/plans"}>
            ...
            <div className="questions text-white my-24 max-w-[1216px] mx-auto">
              ...
              <div className="mt-10 space-y-5">
                <Accordion title="آیا برای ساخت پروفایل جدید نیاز به پرداخت جداگانه وجود دارد؟">
                  بله، برای تماشای تمامی محتوای میلا فیلم به جز قسمت پخش زنده‌ی
                ...
                <Accordion title="پروفایل کاربری چیست؟ با ساخت اکانت (ایجاد حساب کاربری) چه تفاوتی دارد؟">
                  حساب کاربری میلا فیلم پس از ثبت‌نام کاربر به صورت خودکار ایجاد
                  می‌شود. در هر حساب کاربری، امکان ساخت پروفایل‌های مختلف (از
                  جمله پروفایل‌های مختص کودکان) با تنظیمات اختصاصی هر پروفایل و
                ...
                <Accordion title="آیا برای ساخت پروفایل جدید نیاز به پرداخت جداگانه وجود دارد؟">
                  ...
                  است. این شیوه به شما امکان آن را می‌دهد که با یک قرارداد
                  اشتراک میلا فیلمی خود را فعال کنید و پس از آن مبلغ اشتراک به
                  صورت ماهانه از حساب شما کسر خواهد شد. مبلغ اشتراک در دوره‌ی
            ...
            <div className="text-white my-24 px-4 md:px-0 flex-col md:flex-row flex gap-10 max-w-[1216px] mx-auto">
              <div className="bg-milafilmBlack w-full rounded-xl flex items-center pt-10 px-10 flex-col space-y-4">
                ...
                <p className="max-w-[408px] text-center text-xs/[25px] md:text-lg">
                  با میلا فیلم تی وی تلویزیون خود را به یک دستگاه هوشمند با
                  قابلیت نصب برنامه‌های دلخواه تبدیل کنید.{" "}
                </p>
              ...
              <div className="bg-milafilmBlack h-[372px] md:h-[470px] overflow-hidden w-full rounded-xl relative flex items-center pt-10 px-10 flex-col space-y-4">
                ...
                <p className="max-w-[408px] text-center text-xs/[25px] md:text-lg">
                  نقد و بررسی محتواهای روز دنیا را در مجله میلا فیلم بخوانید و
